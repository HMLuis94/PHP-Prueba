  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width:700px">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Añadir Moneda</h4>
      </div>
...
<form>
  ...
  <label style="margin:7px" for="NM">Nombre Moneda</label>
   <input class="form-control" type="text" id="NM" required>
  </div>
</form>
...
var datas="NM="+NM;
	...
	var r = confirm("¿Deseas eliminar esta moneda (si esta siendo usada no se podrá borrar)?");
    if (r == true) {
	var id = str;
     $.ajax({
	   type: "GET",
